        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
                    ...
                    >
                        <div className="w-14 h-14 bg-rose-50 dark:bg-rose-900/20 rounded-2xl flex items-center justify-center mx-auto mb-4 text-rose-600 dark:text-rose-400 relative">
                            <div className="absolute inset-0 rounded-2xl bg-rose-500/20 animate-ping opacity-20"></div>
                        ...
                        <div className="flex gap-2">
                            <button
                                onClick={onConfirm}
                                disabled={loading}
                                className="flex-1 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-xl font-black text-[11px] shadow-md transition-all active:scale-95 disabled:opacity-50"
                            >
                                {loading ? 'جاري...' : 'نعم، حذف'}
                            </button>
                            <button
                                onClick={onClose}
