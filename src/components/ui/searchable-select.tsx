...
export function SearchableSelect({ label, value, onChange, options, placeholder, required, className }: SearchableSelectProps) {
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: 5 }}
                        className="absolute z-[1000] top-full mt-2 w-full bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-700 rounded-2xl shadow-2xl overflow-hidden"
                    >
